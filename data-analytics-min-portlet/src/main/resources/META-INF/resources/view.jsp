...
<script>
function minVisualization(taskid) {
	{Liferay.Service(
		'/iam.token/get-token',
		function(obj) {
			var token = obj.token;
			$.ajax({
		        ...
		        url: "<%=serveResource%>",
		   	    success: function (response) {
		   	    	$("#min").html('<img src="data:image/png;base64,' + response + '" />');
		        }
		    });
		}
	)};
...
<div class="panel panel-default">
	<div class="panel-body" id="min">
			<p>Select an ensemble task from the Experiment monitoring table to visualise the minimum map.</p>
	</div>
</div>
